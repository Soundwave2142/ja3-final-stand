...
---
--- !Important! Config switching is not supported yet! But is planned.
---
...
DefineClass.FinalStandTemplatePresetsGenerator = {
    Structure = {
        --FinalStandConfigDef = {
        --    globalName = 'FinalStandConfigs',
        --    displayName = T(892716651495, "Final Stand - Configs"),
        --    gameObjName = 'finalStandConfig'
        --},
        {
